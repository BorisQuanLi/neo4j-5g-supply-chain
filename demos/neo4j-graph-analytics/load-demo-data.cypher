...
MATCH (samsung:Company {name: "Samsung Electronics Co Ltd"})
MATCH (qualcomm:Company {name: "QCOM (QUALCOMM Inc)"})
MATCH (arm:Company {name: "ARM Holdings plc"})
MATCH (tsmc:Company {name: "TSM (Taiwan Semiconductor Manufacturing Co Ltd)"})
MATCH (mediatek:Company {name: "MediaTek Inc"})
MATCH (xiaomi:Company {name: "Xiaomi Corporation"})
CREATE
